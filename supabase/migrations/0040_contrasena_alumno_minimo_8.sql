-- Ajuste sobre la migración 0039 el mismo día, pedido de Nalux: "que la
-- contraseña del alumno sea mínimo 8 caracteres, con una mayúscula" -- el
-- mínimo pasa de 4 a 8. La mayúscula ya quedaba exigida desde 0039, se
-- mantiene igual.
